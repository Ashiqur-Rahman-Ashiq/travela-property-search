...
import 'package:flutter_clean_boilerplate/helper/debounce_helper.dart';
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            ((widget.totalSize == null || _offset! >= (widget.totalSize! / (widget.limit ?? 10)).ceil() || _offsetList.contains(_offset! + 1)))
                ? const SizedBox()
                : Center(
                    child: Padding(
