import 'package:flutter_clean_boilerplate/helper/responsive_helper.dart';
import 'package:flutter_clean_boilerplate/main.dart';

class Dimensions {
  static  double fontSizeExtraSmall = Get.context != null && ResponsiveHelper.isTab(Get.context!) ? 14 : 10.0;
  static  double fontSizeSmall = Get.context != null && ResponsiveHelper.isTab(Get.context!) ? 16 : 12.0;
  static  double fontSizeDefault = Get.context != null && ResponsiveHelper.isTab(Get.context!) ? 18 : 14.0;
  static  double fontSizeLarge = Get.context != null && ResponsiveHelper.isTab(Get.context!) ? 22 : 16.0;
  static  double fontSizeExtraLarge = Get.context != null && ResponsiveHelper.isTab(Get.context!) ? 26 : 18.0;
  static  double fontSizeOverLarge =  Get.context != null && ResponsiveHelper.isTab(Get.context!) ? 28 : 24.0;
  ...
  static const double radiusHundred = 100.0;
